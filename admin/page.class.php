...
class page{
	...
	public function getPageList(){
		...
		$html = '';
		if($this->page>4){
			$html = "<a href=\"#\" onclick=\"getGoods('{$this->url}page=1')\">&laquo;</a><a href=\"#\" onclick=\"getGoods('{$this->url}page=1')\">1</a> ";
		}
		...
		if($this->page+3<$this->total){
			$html .= " <a href=\"#\" onclick=\"getGoods('{$this->url}page={$this->total}')\">{$this->total}</a><a href=\"#\" onclick=\"getGoods('{$this->url}page={$this->total}')\">&raquo;</a>";
		}
		//返回拼接结果
		return $html;
	}
